...
### README Todos
- [ ] **Add live demo link and screen recording to Demo section**
- [ ] **Add screenshots for Swagger UI, search results, metrics dashboard, and file upload flow**
- [ ] **Fill in Known Limitations & Future Improvements section with current limitations and roadmap**
